...
class Laporan_terbanyak_admin extends Admin_Controller 
{
	...
	{   
        ...
        $data['page_title'] = 'Laporan Terbanyak';
        $data['page_description'] = '';
        $data['message'] = $this->session->flashdata('message');
        $data['dt_jam_tebanyak'] = $this->data_model->_getJam();
        $data['dt_maskapai_tebanyak'] = $this->data_model->_getMaskapai();

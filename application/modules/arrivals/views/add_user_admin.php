...
<div class="content-wrapper">
  ...
  <section class="content">
    ...
    <div class="row">
      <div class="col-sm-12">
        <div class="box box-primary">
          ...
          <div class="box-body">
            <div class="col-sm-6">
              <a class="btn btn-app" href="<?php echo site_url('admin/arrivals'); ?>">
                <i class="fa fa-arrow-left"></i> Back
              </a>
              <a class="btn btn-app" href="<?php echo site_url('admin/arrivals/add'); ?>">
    ...
    <div class="row">
      <div class="col-sm-12">
        <?php echo form_open_multipart('admin/arrivals/add'); ?>
